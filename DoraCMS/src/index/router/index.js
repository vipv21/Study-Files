...
import { ArticleList, CmsCase,Ordert, Article, AdminLogin, UserLoginForm, UserRegForm, UserCenter, UserPwd, UserMessage, UserReplies, UserAddContent, UserContents, SiteMap } from 'create-route'
...
export function createRouter() {
    const router = new VueRouter({
        ...
        routes: [
            ...
            { name: 'ordert', path: '/ordert___:typeId?/:current(\\d+)?', component: Ordert },  //新增临时页面
