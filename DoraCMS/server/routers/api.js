...
const { AdminUser, ContentCategory, Content, ContentTag, User, Message, SystemConfig, UserNotify, Ads,UserSearch } = require('../lib/controller');
...
// 普通用户登录查询
router.post('/users/search', UserSearch.searchOne); //先引入路径后调用改文件下的方法
